...
export default function Auth() {
    ...
    try {
      if (tab === 'signin') {
        ...
        if (error) {
          ...
          toast({
            title: 'Welcome to AllStars DAVV',
  ...
  return (
    <div className="min-h-[100dvh] flex items-center justify-center bg-gradient-to-br from-background via-muted/30 to-background p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-4 animate-fade-in relative z-10">
        {/* Logo & Tagline */}
        <div className="text-center space-y-1">
          <div className="flex justify-center">
            <Logo size="xl" className="drop-shadow-lg" />
          </div>
          <p className="text-sm sm:text-base text-muted-foreground font-medium">Discover talent. Form teams. Collaborate.</p>
        </div>
        ...
        <Card className="border-0 shadow-card bg-card/80 backdrop-blur-sm">
          <CardContent className="p-4 sm:p-6 space-y-3">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <Button type="submit" className="w-full bg-gradient-primary hover:opacity-90 shadow-glow h-9" disabled={loading}>
